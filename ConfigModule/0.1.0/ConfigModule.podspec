...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/macer-sources/ConfigModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '抓猫的鱼' => 'playtomandjerry@gmail.com' }
  s.source           = { :git => 'https://github.com/macer-sources/ConfigModule.git', :tag => s.version.to_s }
